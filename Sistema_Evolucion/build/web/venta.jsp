        ...
        <div class="container">
            ...
            <div class="productos">
                ...
                <form action="servletDetalleventa"> 
                    ...
                    <p align="center"><input class="btn" type="submit" name="accion" value="agregar" onclick="return producto()"></p>
                    <input type="hidden" name="dni" value="<%=request.getParameter("dni")%>">
                </form>                  
                ...
                <p align="center"><input class="btn" type="submit" name="vender" value="Vender"><input class="btn salir" type="submit" name="Cancelar" value="Cancelar" ></p>
                    <%
                        ...
                        if (request.getParameter("vender") != null) {
                            ...
                            if (lolo.equals("0")) {
                                response.sendRedirect("index.jsp?msg=La venta se realizo con Exito");
                            } else {
                        ...
                        if (request.getParameter("Cancelar") != null) {
                            ...
                            if (lolo.equals("0")) {
                                response.sendRedirect("index.jsp?msg=La venta se cancelo con Exito");
                            } else {
                                response.sendRedirect("index.jsp?msg=La venta se cancelo con Exito");
                            }
                        }
