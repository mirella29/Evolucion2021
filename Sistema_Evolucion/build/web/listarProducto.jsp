...
<html>
    ...
    <body>
        <div class="container">
            <h1 class="titulo" align="center">Lista de Productos</h1>
            <table class="table table-striped">
                <thead>
                    <tr>
                        <td colspan="2" align="center"> <a class="btn" href="agregarProducto.jsp">Agregar</a></td>
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td> <a class="btn editar" href="editarProducto.jsp?cod=<%=lista.get(i).getId()%>">Editar</a> </td>
                        <td> <a class="btn eliminar" href="servletProducto?accion=eliminar&cod=<%=lista.get(i).getId()%>">Eliminar</a> </td>
                    </tr>
                    <%}
                    %>
                </tbody>
            ...
            <form>
                <h1 class="buscar" align="center">Busqueda de Producto</h1>
