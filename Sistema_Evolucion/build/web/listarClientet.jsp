    ...
    <body>
        <div class="container">
            ...
            <table class="table table-striped">
                ...
                <thead>
                    <tr>
                        <td colspan="2" align="center"> <a class="btn" href="agregarClientet.jsp">Agregar</a></td>
                        <td><a class="btn salir" href="indext.jsp">Salir</a></td
                    </tr>
                    <tr align="center">
                        <td>Id</td><td>Dni</td><td>Nombre</td><td>Apellido</td><td>Direccion</td><td>Telefono</td><td>ACCIONES</td>
                    </tr>
                </thead>
                <style>  
                    body{
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td> <a class="btn editar"href="editarClientet.jsp?cod=<%=lista.get(i).getId_cliente()%>">Actualizar</a> </td>
                    </tr>
                    <%}
                    %>
                </tbody>
            ...
            <form>
                ...
                <p align="center"> <input  type="text" placeholder="Ingrese dni" name="buscado" required="" onkeypress="return numeros(event)" maxlength="8"> <input type="submit" name="Buscar" value="Buscar" class="btn"> </p>
                <input type="hidden" name="accion" value="buscart">
            </form>    
